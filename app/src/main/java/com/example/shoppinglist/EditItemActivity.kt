...
class EditItemActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        save.setOnClickListener{
            ...
            {
                val documentReference: DocumentReference = firebaseFirestore.collection("lists").document(firebaseUser!!.uid).collection("myLists").document(data.getStringExtra("listId")!!).collection("items").document(data.getStringExtra("itemId")!!)
                val list: MutableMap<String, Any> = mutableMapOf()
                list.put("item",newTitle)
        ...
        val listTitle:String=data.getStringExtra("item")!!
